...
export const ARGON2_DEFAULT_MEMORY = 262144; // 256 MiB (KiB)
export const ARGON2_DEFAULT_ITERATIONS = 10;
export const ARGON2_DEFAULT_PARALLELISM = 4;
export const ARGON2_MIN_MEMORY = 65536; // 64 MiB — hard floor
export const ARGON2_MAX_MEMORY = 524288; // 512 MiB
export const ARGON2_TARGET_MS = 1000; // 1.0s target
...
export async function benchmarkArgon2(): Promise<Argon2Params> {
  ...
  // Scale from calibration (8MB, 1 iter) to defaults (memory MB, N iters) — same parallelism
  const estDefault = elapsed * (ARGON2_DEFAULT_MEMORY / 8192) * iterations;
