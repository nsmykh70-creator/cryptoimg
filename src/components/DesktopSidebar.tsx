...
import { ActiveTab, Argon2Params, Language } from '../types';
...
export const DesktopSidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-60 bg-slate-950/60 border-r border-slate-800/80 flex flex-col justify-between select-none flex-shrink-0 z-20">
      ...
      {/* Bottom Actions: Security Status, Memory Sanitize & FAQ */}
      <div className="p-3 border-t border-slate-800/80 space-y-2">
        {/* Security Status — moved from right panel */}
        <div className="p-2.5 rounded-lg bg-slate-900/70 border border-slate-800/90 space-y-2">
          <div className="flex items-center gap-1.5 text-[10px] uppercase font-bold tracking-wider text-slate-500 font-mono">
            ...
            <div className="flex items-center justify-between text-[11px]">
              ...
              {argon2Params && (
                <span className="text-[10px] text-slate-300 font-mono">
                  {argon2Params.memory / 1024}MB / t={argon2Params.iterations}
                </span>
              )}
            </div>
