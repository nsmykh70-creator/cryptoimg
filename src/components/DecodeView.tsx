  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-slate-900/40 select-none">
      ...
      <div className="w-full flex flex-col h-full overflow-y-auto p-4 space-y-4">
        ...
        {/* 2. Decryption Key — PIN or Passphrase */}
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 bg-slate-950/80 rounded-lg border border-slate-800 p-0.5">
              <button type="button" onClick={() => { setAuthMode('pin'); setPin(''); }}
              ...
              <button type="button" onClick={() => { setAuthMode('passphrase'); setPin(''); }}
          ...
          <div className="relative">
            <input
              ...
              value={pin}
              onChange={(e) => setPin(authMode === 'pin' ? e.target.value.replace(/\D/g, '').slice(0, 11) : e.target.value)}
              placeholder={authMode === 'pin' ? t.dec_pin_placeholder : 'Enter passphrase (12+ characters)'}
              maxLength={authMode === 'pin' ? 11 : undefined}
